...
'The nunique() method returns the counts of the unique values'
...
'Either are fine - value counts could be used to answer most and least in one go - that is what I would expect to see'
...
'For better context, see if students have found out how many matches are recorded for England overall. It puts the 325 matches into much better context!'
